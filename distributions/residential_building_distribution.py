...
class ResidentialBuildingDistribution(TimeSpaceDistribution):
    ...
    def __init__(self):
        ...
        timeDistribution = TimeDistribution(timeType, maxTimeTyped, [(5, 0.4), (6, 1), (10, 0.6), (11, 0.6), (12, 0.8), (13, 0.8), (14, 0.6), (15, 0.6), (19, 1), (20, 0.4), (24, 0.4)])

        # Initialize the TimeSpaceDistribution
        super().__init__(maxPassengers, timeType, maxTimeTyped, data, timeDistribution, "Residential Building")